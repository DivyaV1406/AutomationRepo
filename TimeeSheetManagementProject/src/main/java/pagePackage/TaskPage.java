...
public class TaskPage {
	...
	@FindBy(xpath = "//select[@name='customerId']") private WebElement selectCustomerToCreateTask;
	@FindBy(xpath = "//select[@name='projectId']") private WebElement selectProjectToCreateTask;
	//@FindBy(xpath = "(//option[@value='10'])[1]") private WebElement 
